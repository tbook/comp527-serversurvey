...
MIN_RESPONSE_COUNT = 5  #The minimum number of times a response code must appear to be considered
MIN_SERVER_COUNT = 5    #The minimum number of times a server type must appear to be considered
